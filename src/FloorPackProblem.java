public class FloorPackProblem {
    ...
    public static void main(String args[]) {
        ...
        System.out.println(canPack(2, 2, 11)); // should return true since bigCount is 2 (big bags of 5 kilos each) and smallCount is 2 (small bags of 1 kilos), makes in total 12 kilos and goal is 11 kilos
